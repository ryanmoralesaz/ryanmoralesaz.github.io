...
class ContentScraper extends Component {
  constructor() {
    super();
      ...
      <div>
        ...
        <Modal isOpen={this.state.modalIsOpen} onAfterOpen={this.afterOpenModal} onRequestClose={this.closeModal} contentLabel="Example Modal">
          <div>
            ...
            <h1 style={{ textAlign: "center", marginBottom: "3rem" }}>Content Scraper</h1>
            <h2>Description</h2>
            <p>Retrieves data using npm package cheerio</p>
            <Row className="w-50 m-auto">
              <Col>
                <CardImg src={contentScraper} style={{ height: "300px" }} />
              </Col>
            </Row>
